      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-4">Ligação Indisponível</h2>
            <p className="text-gray-600 mb-6">Você precisa ter uma consulta agendada para fazer ligações.</p>
            <Button
