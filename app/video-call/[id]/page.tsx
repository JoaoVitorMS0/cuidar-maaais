      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="text-center">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Videochamada Indisponível</h2>
            <p className="text-gray-600 mb-6">Você precisa ter uma consulta agendada para fazer videochamadas.</p>
            <Button
    ...
    <div className="min-h-screen bg-black flex flex-col">
        ...
        {showInfoContainer && (
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            <div className="bg-black/30 backdrop-blur rounded-2xl p-6">
              ...
              <p className="text-sm opacity-60 mt-2">{callConnected ? "Conectado" : "Conectando..."}</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="bg-black/50 backdrop-blur p-6">
        <div className="flex justify-center space-x-8">
          ...
          <Button size="icon" className="w-16 h-16 rounded-full bg-red-500 hover:bg-red-600" onClick={endCall}>
